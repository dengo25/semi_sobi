...
import sobi.vo.review.CommentReportVO;
...
public class CommentReportDAO {
    ...
    // 댓글 신고 등록 (MySQL: COMMENT_REPORT_ID는 AUTO_INCREMENT)
    public int insertReport(CommentReportVO vo) {
        int result = 0;
        String sql = "INSERT INTO COMMENT_REPORT(COMMENT_ID, COMMENT_REPORTING_USER_ID, COMMENT_REPORTED_USER_ID, REPORT_CATEGORY, COMMENT_REPORT_DETAIL) "
                   + "VALUES (?, ?, ?, ?, ?)";
